_base_ = [
    '../_base_/datasets/crowdpose_keypoint.py', '../_base_/default_runtime.py'
]
...
model = dict(
    ...
    bbox_head=dict(
        type='opera.PETRHead',
        num_classes=1,
        num_keypoints=14,  # CrowdPose has 14 keypoints
        in_channels=2048,
        num_query=300,
        ...
        loss_oks=dict(type='opera.OKSLoss', num_keypoints=14, loss_weight=2.0),
        loss_hm=dict(type='opera.CenterFocalLoss', loss_weight=4.0),
        loss_kpt_refine=dict(type='mmdet.L1Loss', loss_weight=70.0),
        loss_oks_refine=dict(type='opera.OKSLoss', num_keypoints=14, loss_weight=2.0)),
    train_cfg=dict(
        assigner=dict(
            type='opera.PoseHungarianAssigner',
            cls_cost=dict(type='mmdet.FocalLossCost', weight=2.0),
            kpt_cost=dict(type='opera.KptL1Cost', weight=70.0),
            oks_cost=dict(type='opera.OksCost', num_keypoints=14, weight=7.0))),
