...
def build_dataloader(dataset,
    ...
    # Use sequential collate for PosetrackSequentialDataset
    from .posetrack_video_pose import PosetrackSequentialDataset, sequential_collate
    if isinstance(dataset, PosetrackSequentialDataset):
        collate_fn = partial(sequential_collate,
