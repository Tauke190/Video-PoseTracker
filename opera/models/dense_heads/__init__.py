...
# from .PAVEHeadMulFrames  import VideoPoseHeadV18_2
...
from .pave_head_mul_frames import PAVEHeadMulFrames

__all__ = ['DKDETRHead', 'InsPoseHead', 'PETRHead', 'SOITHead', 'PAVEHeadMulFrames']
